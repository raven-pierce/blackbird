<x-filament::page>
    ...
    @if($lectures->isNotEmpty())
        ...
        <div class="mt-32 grid grid-cols-[repeat(auto-fill,minmax(20rem,1fr))] gap-16">
            @foreach($lectures as $lecture)
                <div class="flex flex-col justify-center rounded-md bg-white dark:bg-gray-800 shadow-md p-6">
                    ...
                    <span class="mt-6 text-xl font-bold text-gray-700 dark:text-white">{{ $lecture->start_time->format('h:i A') }}</span>
