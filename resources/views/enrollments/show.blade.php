    ...
    <x-slot name="description">
        <p class="mt-8 text-gray-700">
            This course has <span
                class="font-semibold text-indigo-500 lowercase">{{ $spellOutFormatter->format($enrollment->section->lectures->count()) }}
            ...
            and last <span class="font-semibold text-indigo-500">{{ $enrollment->section->lectures->first()->duration }}
